...
class SetForm extends React.Component {
  ...
  fetchTerms = async () => {
    ...
    this.setState({cards:this.arrayToObject(response.cards), set:response.set});
  }
  ...
  createCard = () => {
    ...
    this.setState({cards:{...this.state.cards, [newId]:{newCard:true}}})
  ...
  readInitialState = () => {
    ...
    if(this.state.init)
    {
      ...
      return {cards, set:{title:this.state.set.name, description:this.state.set.description}};
    }
  }
